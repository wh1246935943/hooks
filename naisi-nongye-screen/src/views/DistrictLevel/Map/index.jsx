        ...
        <div class="dl-center">
          ...
          >
            ...
            <g
              ...
              style="transform: translate(390px, 275px) scale(0.9);cursor: pointer;"
            >
              ...
              <g
                style="transform: translate(86px, 58px) scale(1.1)"
              >
                <image
                  href={new URL(`@/assets/district-level/text-box-3.png`, import.meta.url).href}
                />
                <text
                  onClick={router.push.bind(null, { name: 'VillageLevel' })}
                  style={`
            ...
            </g>
            {
              (isInfoBox || mapType === 'GIS') && (
                <g
                  ...
                  style="transform: translate(473px, 164px) scale(0.9);"
                >
                  <image
